...
export const CardHeader: React.FC<CardHeaderProps> = ({ children, className = '', ...props }) => {
  return (
    <div
      className={`px-6 py-5 border-b border-gray-50/50 flex flex-col gap-1 ${className}`}
      {...props}
    >
      {children}
    </div>
...
export const CardFooter: React.FC<CardFooterProps> = ({ children, className = '', ...props }) => {
  return (
    <div
      className={`px-6 py-4 bg-gray-50/50 flex items-center justify-between ${className}`}
      {...props}
    >
      {children}
    </div>
